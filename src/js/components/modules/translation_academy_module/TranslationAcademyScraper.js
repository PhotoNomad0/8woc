...
// this defines a new function that will be called later, reg ex gets HTML to scrape
    ...
    // base goes to GOGS , TA_URL goes to translation academy
      oReq.open("Get", url || BASE_URL + TA_URL, true);
      // sends the request
      oReq.send();

  }
// gets the actual file from GOGS
